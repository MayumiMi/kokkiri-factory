    ...
    <div className="container mx-auto p-4 bg-white">
      ...
      <div className="flex justify-between items-center mb-4">
        ...
        {/* <Button asChild className="bg-blue-600 hover:bg-blue-700 text-white">
          <Link href="performance/input-admin">Add Admin</Link>
        </Button> */}
      </div>
              ...
              currentAdmins.map((admin, index) => (
                <tr key={index} className="hover:bg-gray-50">
                  <td className="border px-4 py-2 flex items-center gap-2">
                    ...
                    {admin.icon && <span className="inline-block">{admin.icon}</span>}
                  </td>
      ...
      <div className="flex justify-center items-center mt-4 gap-2">
        {/* First Page Button */}
        <Button variant="ghost" disabled={currentPage === 1} onClick={() => handlePageChange(1)}>
          First Page
        </Button>
        ...
        {/* Last Page Button */}
        <Button variant="ghost" disabled={currentPage === totalPages} onClick={() => handlePageChange(totalPages)}>
          Last Page
        </Button>
      </div>
    </div>
